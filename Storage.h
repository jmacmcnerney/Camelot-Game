...
--		"Storage" Place in Camelot, and contains data and code for what can occur in this location.
*/
#pragma once
#include <vector>
#include <string>
...
public:
	Storage();
	Storage(string name); //overloaded constructor for giving the location a Camelot name immediately
